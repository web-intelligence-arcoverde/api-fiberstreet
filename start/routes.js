...
Route.group(() => {
  ...
  Route.resource('splittercto', 'SplitterCtoController')
    .apiOnly()
    //.middleware(new Map([[['splittercto'], ['can:map-modify']]]))

  Route.resource('splitters', 'SplitterController')
    .apiOnly()
...
Route.group(() => {
  Route.resource('cables', 'CableController')
    .apiOnly()
    .middleware(new Map([[['cables.store', 'cables.update', 'cables.destroy'], ['can:map-modify']]]))
  ...
  Route.resource('fibers', 'FiberController')
    .apiOnly()
    // .middleware(
    //   new Map([
    //     [
