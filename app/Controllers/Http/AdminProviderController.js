...
class AdminProviderController {
  ...
  /**
   * Render a form to be used for creating a new adminprovider.
  ...
  /**
   * Create/save a new adminprovider.
   * POST adminproviders
   *
   * @param {object} ctx
   * @param {Request} ctx.request
  ...
  /**
   * Display a single adminprovider.
   * GET adminproviders/:id
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing adminprovider.
   * GET adminproviders/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
